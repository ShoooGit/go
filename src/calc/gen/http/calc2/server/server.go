...
// Server lists the calc2 service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Minus  http.Handler
}
...
// New instantiates HTTP handlers for all the calc2 service endpoints using the
...
func (s *Server) Service() string { return "calc2" }
...
// Mount configures the mux to serve the calc2 endpoints.
func Mount(mux goahttp.Muxer, h *Server) {
	MountMinusHandler(mux, h.Minus)
}

// MountMinusHandler configures the mux to serve the "calc2" service "minus"
// endpoint.
...
// calls the "calc2" service "minus" endpoint.
