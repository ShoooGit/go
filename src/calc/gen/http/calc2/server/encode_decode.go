...
//
// calc2 HTTP server encoders and decoders
//
// Command:
// $ goa gen calc/design
...
// EncodeMinusResponse returns an encoder for responses returned by the calc2
// minus endpoint.
...
// DecodeMinusRequest returns a decoder for requests sent to the calc2 minus
// endpoint.
